IntegratedList <- function(client, SampleIDs, DFdataDFs){
    cat(" -> Magazine. \n")
    ...
    cat(" This process successfully ended. \n")
    # return IntegraedList class
    return(invisible(
        new("IntegratedList", name = client, Magazine = l1, TV = l2, NewsPaper   = l3, WEB = l4)))
}
